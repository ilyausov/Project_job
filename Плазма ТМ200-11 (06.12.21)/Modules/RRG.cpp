...
void RRGOn(SRRG *object, bool prRRG)
{
	switch (shr[object->nR])	// анализируем шаг режима
	{
		...
		case 1:
		{
			...
			SetOut(prRRG,object->outKl1.nBt,object->outKl1.bMask); 	// открыть Кл-РРГ по 1 или
...
// Описание свойств РРГ1
	...
	ObjRRG[1]->maxFl = 36.0;				// максимальный расход РРГ
	...
	ObjRRG[2]->maxFl = 3.6;				// максимальный расход РРГ
	...
	ObjRRG[3]->maxFl = 9.0;				// максимальный расход РРГ
	...
	ObjRRG[4]->outKl0.nBt = 2;			// выходной дискретный сигнал клапана
	ObjRRG[4]->outKl0.bMask = 0x10;
	ObjRRG[4]->outKl1.nBt = 2;			// выходной дискретный сигнал клапана
	...
	ObjRRG[4]->maxFl = 18.0;				// максимальный расход РРГ
	...
	ObjRRG[5]->outKl0.nBt = 2;			// выходной дискретный сигнал клапана
	ObjRRG[5]->outKl0.bMask = 0x20;
	ObjRRG[5]->outKl1.nBt = 2;			// выходной дискретный сигнал клапана
	...
	ObjRRG[5]->maxFl = 18.0;				// максимальный расход РРГ
	...
	ObjRRG[6]->outKl0.nBt = 3;			// выходной дискретный сигнал клапана
	ObjRRG[6]->outKl0.bMask = 0x2000;
	ObjRRG[6]->outKl1.nBt = 3;			// выходной дискретный сигнал клапана
	...
	ObjRRG[6]->maxFl = 3.6;				// максимальный расход РРГ
