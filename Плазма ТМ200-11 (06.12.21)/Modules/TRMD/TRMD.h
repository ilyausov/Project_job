...
//---------------------------------------------------------------------------
	...
	// 5  :aa0300000004ss\cr\lf		- чтение текущих температур
...
struct STRMD
{
	...
	TEdit
		*Edt_Zad1,			// €чейки вывода заданий и температур
		*Edt_Zad2,
		*Edt_Zad3,
		*Edt_Zad4,
		*Edt_Tek1,
	...
	bool TRMD_Manage(unsigned int,bool); // функци€ св€зи с датчиком
	void TRMD_FrmZap(bool);		// формирование запроса
	bool TRMD_ChkRep(bool);		// обработка ответа
