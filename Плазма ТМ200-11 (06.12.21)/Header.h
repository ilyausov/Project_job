...
float
    ...
    RRG2_MAX = 36.0,           // максимальный расход РРГ2
    RRG2_MIN = 0.0,           // минимальный расход РРГ2
    RRG3_MAX = 3.6,           // максимальный расход РРГ3
    RRG3_MIN = 0.0,           // минимальный расход РРГ3
    RRG4_MAX = 9.0,           // максимальный расход РРГ4
    RRG4_MIN = 0.0,           // минимальный расход РРГ4
    RRG5_MAX = 18.0,           // максимальный расход РРГ5
    RRG5_MIN = 0.0,           // минимальный расход РРГ5
    RRG6_MAX = 18.0,           // максимальный расход РРГ6
    RRG6_MIN = 0.0,           // минимальный расход РРГ6
    RRG7_MAX = 3.6,           // максимальный расход РРГ7
    RRG7_MIN = 0.0,           // минимальный расход РРГ7
    DAVL_MAX = 13.33,         // максимальное давление 13.33
    DAVL_MIN = 0.1,           // минимальное давление
    CESAR_MAX_IP = 1200.0,    // максимальная падающая мощность CESAR ИП
    ...
    CESAR_MAX_PD = 1000.0,    // максимальная падающая мощность CESAR ПД
    ...
    TIME_MAX = 3600.0,        // максимальное время
