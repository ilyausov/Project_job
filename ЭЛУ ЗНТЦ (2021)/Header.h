...
unsigned int
    externalTask = 0x01FF,  // 0x0001 - считать дискретные входные сигналы с PEX-P32C32(1)
                            // 0x0002 - считать дискретные входные сигналы с PEX-P32C32(2)
                            // 0x0004 - считать дискретные входные сигналы с ISO-P32C32
                            // 0x0008 - считать дискретные входные сигналы с ACL7250
                            // 0x0010 - считать аналоговые входные сигналы с ISO-813
                            // 0x0020 - записать аналоговые выходные сигналы в PEX-P32C32(1)
                            // 0x0040 - записать дискретные выходные сигналы в PEX-P32C32(2)
                            // 0x0080 - записать дискретные выходные сигналы в ACL7250
                            // 0x0100 - считать аналоговые уставки с ISO-DA16
...
float
    ...
    RRG1_MAX = 3.6,           // максимальный расход РРГ1
    RRG1_MIN = 0.0,           // минимальный расход РРГ1
    RRG2_MAX = 18.0,           // максимальный расход РРГ2
    ...
    DAVL_MAX = 13.3,         // максимальное давление 13.33
    DAVL_MAX_USER = 10.0,
