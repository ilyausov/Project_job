...
void Init_DatMPT200()
{
	...
	// Датчик 1
	Dat_MPT200[0]->name = "Д1(MPT200)";            // название для отображения
    ...
    // Датчик 2
	Dat_MPT200[1]->name = "Д5(MPT200)";            // название для отображения
	Dat_MPT200[1]->adr = "005";			// адрес
	Dat_MPT200[1]->Pres_MPT200 = &D_D5;      // переменная давления для записи
	Dat_MPT200[1]->SPort = Comport[2];     // порт
	Dat_MPT200[1]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_MPT200[1]->diagnS_mask = 0x10;		// маска байта связной диагностики
	Dat_MPT200[1]->DatMPT200_Gen();

    // Датчик 3
	Dat_MPT200[2]->name = "Д4(MPT200)";            // название для отображения
	Dat_MPT200[2]->adr = "004";			// адрес
	Dat_MPT200[2]->Pres_MPT200 = &D_D4;      // переменная давления для записи
	Dat_MPT200[2]->SPort = Comport[2];     // порт
	Dat_MPT200[2]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_MPT200[2]->diagnS_mask = 0x08;		// маска байта связной диагностики
