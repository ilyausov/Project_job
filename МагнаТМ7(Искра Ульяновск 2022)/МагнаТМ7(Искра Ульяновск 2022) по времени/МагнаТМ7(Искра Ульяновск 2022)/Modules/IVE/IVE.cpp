...
void S_IVE::BU_IVE_Gen()
{
	...
	Pnl_Parent->Height = 600;  // для 1280x1024
...
void S_IVE::BU_IVE_FrmZap(bool Zap_type)
{
	...
	if(type_BU_IVE == 1)  // БПМ
	{
		...
		else // автоматический запрос
		{
			...
			else if(ACom == 2) // запись характеристик
			{
				SPort->PackOut[0] = adr;	// адрес
				SPort->PackOut[1] = 0x57;	// W - запись
				SPort->PackOut[2] = 0x0A;	// длина посылки мл.б.
...
void Init_BU_IVE()
{
	for(int i=0;i<IVE_COUNT;i++ )
    {
	    ...
	    BU_IVE[i]->pr_zap[1] = 0;
	    BU_IVE[i]->pr_zap[2] = 0;
	    BU_IVE[i]->Err = 0;				// кол-во ошибок
	    BU_IVE[i]->Max_err = 5;			// максимум ошибок
	    BU_IVE[i]->ACom = 0;				// текущий автоматический запрос
	    BU_IVE[i]->RCom = 0;				// текущий ручной апрос
	    BU_IVE[i]->Buf_len = 0;			// длина запроса
    }

	// БПИИ
	BU_IVE[0]->name = "БПИИ(ИВЭ341)"; // название для отображения
	BU_IVE[0]->adr = 1;
	BU_IVE[0]->type_BU_IVE = 0;
	BU_IVE[0]->SPort = Comport[0];     // порт
	BU_IVE[0]->diagnS_byte = 0;        // номер байта связной диагностики
	BU_IVE[0]->diagnS_mask = 0x10;		// маска байта связной диагностики

	BU_IVE[0]->Pr_BU_IVE = &PR_SV_II;
	BU_IVE[0]->Kom_BU_IVE[0] = &KOM_II[0];
	BU_IVE[0]->Kom_BU_IVE[1] = &KOM_II[1];
	BU_IVE[0]->Kom_BU_IVE[2] = &KOM_II[2];
	BU_IVE[0]->Kom_BU_IVE[3] = &KOM_II[3];
	BU_IVE[0]->Kom_BU_IVE[4] = &KOM_II[4];
	BU_IVE[0]->Otv_BU_IVE[0] = &OTVET_II[0];
	BU_IVE[0]->Otv_BU_IVE[1] = &OTVET_II[1];
	BU_IVE[0]->Otv_BU_IVE[2] = &OTVET_II[2];
	BU_IVE[0]->Otv_BU_IVE[3] = &OTVET_II[3];
	BU_IVE[0]->Otv_BU_IVE[4] = &OTVET_II[4];
	BU_IVE[0]->Otv_BU_IVE[5] = &OTVET_II[5];
	BU_IVE[0]->Otv_BU_IVE[6] = &OTVET_II[6];
	BU_IVE[0]->Otv_BU_IVE[7] = &OTVET_II[7];
	BU_IVE[0]->Otv_BU_IVE[8] = &OTVET_II[8];
	BU_IVE[0]->Otv_BU_IVE[9] = &OTVET_II[9];
	BU_IVE[0]->BU_IVE_Gen();
	
	// БПМ
	BU_IVE[1]->name = "БПМ(ИВЭ144)"; // название для отображения
	BU_IVE[1]->adr = 2;
	BU_IVE[1]->type_BU_IVE = 1;
	BU_IVE[1]->SPort = Comport[0];     // порт
	BU_IVE[1]->diagnS_byte = 0;        // номер байта связной диагностики
	BU_IVE[1]->diagnS_mask = 0x08;		// маска байта связной диагностики

	BU_IVE[1]->Pr_BU_IVE = &PR_SV_BM;
	BU_IVE[1]->Kom_BU_IVE[0] = &KOM_BM[0];
	BU_IVE[1]->Kom_BU_IVE[1] = &KOM_BM[1];
	BU_IVE[1]->Kom_BU_IVE[2] = &KOM_BM[2];
	BU_IVE[1]->Kom_BU_IVE[3] = &KOM_BM[3];
	BU_IVE[1]->Kom_BU_IVE[4] = &KOM_BM[4];
	BU_IVE[1]->Otv_BU_IVE[0] = &OTVET_BM[0];
	BU_IVE[1]->Otv_BU_IVE[1] = &OTVET_BM[1];
	BU_IVE[1]->Otv_BU_IVE[2] = &OTVET_BM[2];
	BU_IVE[1]->Otv_BU_IVE[3] = &OTVET_BM[3];
	BU_IVE[1]->Otv_BU_IVE[4] = &OTVET_BM[4];
	BU_IVE[1]->Otv_BU_IVE[5] = &OTVET_BM[5];
	BU_IVE[1]->Otv_BU_IVE[6] = &OTVET_BM[6];
	BU_IVE[1]->Otv_BU_IVE[7] = &OTVET_BM[7];
	BU_IVE[1]->Otv_BU_IVE[8] = &OTVET_BM[8];
	BU_IVE[1]->Otv_BU_IVE[9] = &OTVET_BM[9];
	BU_IVE[1]->BU_IVE_Gen();
}