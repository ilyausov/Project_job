...
void Init_DatMERA()
{
	...
	// Датчик 2
	Dat_MERA[1]->name = "Д2-ТМН(ПМТ)";            // название для отображения
	Dat_MERA[1]->adr = "02";			// адрес
	Dat_MERA[1]->Pres_MERA = &D_D2;      // переменная давления для записи
	Dat_MERA[1]->SPort = Comport[1];     // порт
	Dat_MERA[1]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_MERA[1]->diagnS_mask = 0x02;		// маска байта связной диагностики
