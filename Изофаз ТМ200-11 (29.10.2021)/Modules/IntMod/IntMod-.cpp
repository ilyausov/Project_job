...
void IM_Gen(unsigned char Mod_Count)
{
	...
	IntMod[0]->TS_Pan->Caption = "Связь модулей/интерфейса";
	...
	IntMod[0]->Lbl_Uni->Caption = "Уровни вакуума";
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "Подъемник вверх";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "Подъемник вниз";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "Прижим в Home";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "Запуск техпроцесса";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "Готовность модуля";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "ЩЗ открыт";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
	...
	IntMod[0]->Lbl_Uni->Left = 32;
	IntMod[0]->Lbl_Uni->Caption = "ЩЗ закрыт";
	IntMod[0]->Lbl_Uni->Font->Name = "Arial";
	IntMod[0]->Lbl_Uni->Font->Size = 12;
	IntMod[0]->Lbl_Uni->Font->Color = clBlack;
	IntMod[0]->Lbl_Uni->Transparent = true;
    ...
    for(int i=0;i<Mod_Count;i++)
	{
		for(int j=0;j<IMBits_COUNT;j++)
		{
	        ...
	        IntMod[i]->Lbl_Uni->Caption = "Модуль " + IntToStr(IntMod[i]->adr);
	        IntMod[i]->Lbl_Uni->Font->Name = "Arial";
...
//---------------------------------------------------------------------------
void Visual_IM()       // обновить страницу
{
...
void Init_SIntMod()
{
	...
	// Модуль 2
	IntMod[0]->adr = 0x02;
	IntMod[0]->Type_Im = 0;				// тип: 1-интерф./0 - модуль
	IntMod[0]->Buf_len = 0;
	IntMod[0]->diagnS_byte = 2;        	// номер байта связной диагностики
	IntMod[0]->diagnS_mask = 0x10;		// маска байта связной диагностики
    IntMod[0]->Err = 0;
	if(IntMod[0]->Type_Im)
		IntMod[0]->Max_err = 5;
	else
