...
void Init_DatPPT200()
{
	...
	// Датчик 1
	Dat_PPT200[0]->name = "Д6(PPT200 ТМН)";		// название для отображения
	Dat_PPT200[0]->adr = "006";				// адрес
	Dat_PPT200[0]->Pres_PPT200 = &D_D6;      // переменная давления для записи
	Dat_PPT200[0]->SPort = Comport[2];     // порт
	Dat_PPT200[0]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[0]->diagnS_mask = 0x20;		// маска байта связной диагностики
	Dat_PPT200[0]->DatPPT200_Gen();

    // Датчик 2
	Dat_PPT200[1]->name = "Д5(PPT200 гелий)";		// название для отображения
	Dat_PPT200[1]->adr = "005";				// адрес
	Dat_PPT200[1]->Pres_PPT200 = &D_D5;      // переменная давления для записи
	Dat_PPT200[1]->SPort = Comport[2];     // порт
	Dat_PPT200[1]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[1]->diagnS_mask = 0x10;		// маска байта связной диагностики
