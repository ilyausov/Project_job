...
// Описание свойств РРГ1
	...
	ObjRRG[1]->maxFl = 0.9;				// максимальный расход РРГ
	...
	ObjRRG[2]->diagnNVR.nBt = 7;
	ObjRRG[2]->diagnNVR.bMask = 0x01;	// нет выхода на режим РРГ
	ObjRRG[2]->diagnBOR.nBt = 7;
	ObjRRG[2]->diagnBOR.bMask = 0x02;	// большая ошибка регулирования РРГ
	ObjRRG[2]->diagnNR.nBt = 7;
	ObjRRG[2]->diagnNR.bMask = 0x04;	// нет регулирования РРГ
	ObjRRG[2]->diagnSUM.nBt = 7;
	ObjRRG[2]->diagnSUM.bMask = 0x07;	// суммарные диагностики режима 
	ObjRRG[2]->outKl0.nBt = 1;			// выходной дискретный сигнал клапана
	ObjRRG[2]->outKl0.bMask = 0x1000;
	ObjRRG[2]->outKl1.nBt = 1;			// выходной дискретный сигнал клапана
	ObjRRG[2]->outKl1.bMask = 0x2000;
