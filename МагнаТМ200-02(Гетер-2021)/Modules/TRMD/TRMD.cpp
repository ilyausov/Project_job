...
void Init_TRMD()
{
	...
	// Датчик 1
	TRMD[0]->name = "Термодат";            // название для отображения
	TRMD[0]->adr = "01";			// адрес
	...
	TRMD[0]->SPort = Comport[3];     // порт
	TRMD[0]->diagnS_byte = 2;        // номер байта связной диагностики
	TRMD[0]->diagnS_mask = 0x10;		// маска байта связной диагностики

	TRMD[0]->Err = 0;				// кол-во ошибок
	TRMD[0]->Max_err = 5;			// максимум ошибок
	TRMD[0]->ACom = 5;				// текущий автоматический запрос
