...
void Init_DatPPT200()
{
	...
	// Датчик 1
	Dat_PPT200[0]->name = "Д1(PPT200)";		// название для отображения
	Dat_PPT200[0]->adr = "001";				// адрес
	Dat_PPT200[0]->Pres_PPT200 = &D_D1;      // переменная давления для записи
	Dat_PPT200[0]->SPort = Comport[2];     // порт
	Dat_PPT200[0]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[0]->diagnS_mask = 0x01;		// маска байта связной диагностики
	Dat_PPT200[0]->DatPPT200_Gen();

    // Датчик 2
	Dat_PPT200[1]->name = "Д2(PPT200)";		// название для отображения
	Dat_PPT200[1]->adr = "002";				// адрес
	Dat_PPT200[1]->Pres_PPT200 = &D_D2;      // переменная давления для записи
	Dat_PPT200[1]->SPort = Comport[2];     // порт
	Dat_PPT200[1]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[1]->diagnS_mask = 0x02;		// маска байта связной диагностики
	Dat_PPT200[1]->DatPPT200_Gen();

    // Датчик 3
	Dat_PPT200[2]->name = "Д5(PPT200)";		// название для отображения
	Dat_PPT200[2]->adr = "005";				// адрес
	Dat_PPT200[2]->Pres_PPT200 = &D_D5;      // переменная давления для записи
	Dat_PPT200[2]->SPort = Comport[2];     // порт
	Dat_PPT200[2]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[2]->diagnS_mask = 0x10;		// маска байта связной диагностики
	Dat_PPT200[2]->DatPPT200_Gen();

    // Датчик 4
	Dat_PPT200[3]->name = "Д6(PPT200)";		// название для отображения
	Dat_PPT200[3]->adr = "006";				// адрес
	Dat_PPT200[3]->Pres_PPT200 = &D_D6;      // переменная давления для записи
	Dat_PPT200[3]->SPort = Comport[2];     // порт
	Dat_PPT200[3]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[3]->diagnS_mask = 0x20;		// маска байта связной диагностики
	Dat_PPT200[3]->DatPPT200_Gen();

    // Датчик 5
	Dat_PPT200[4]->name = "Д3(PPT200)";		// название для отображения
	Dat_PPT200[4]->adr = "003";				// адрес
	Dat_PPT200[4]->Pres_PPT200 = &D_D3;      // переменная давления для записи
	Dat_PPT200[4]->SPort = Comport[3];     // порт
	Dat_PPT200[4]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_PPT200[4]->diagnS_mask = 0x04;		// маска байта связной диагностики
