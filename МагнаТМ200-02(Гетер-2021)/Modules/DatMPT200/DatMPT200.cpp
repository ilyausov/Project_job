...
void Init_DatMPT200()
{
	...
	// Датчик 1
	Dat_MPT200[0]->name = "Д4(MPT200)";            // название для отображения
	Dat_MPT200[0]->adr = "004";			// адрес
	Dat_MPT200[0]->Pres_MPT200 = &D_D4;      // переменная давления для записи
	Dat_MPT200[0]->SPort = Comport[2];     // порт
	Dat_MPT200[0]->diagnS_byte = 0;        // номер байта связной диагностики
	Dat_MPT200[0]->diagnS_mask = 0x08;		// маска байта связной диагностики

	Dat_MPT200[0]->Err = 0;				// кол-во ошибок
	Dat_MPT200[0]->Max_err = 5;			// максимум ошибок
	Dat_MPT200[0]->ACom = 0;				// текущий автоматический запрос
	Dat_MPT200[0]->RCom = 0;				// текущий ручной апрос
	Dat_MPT200[0]->Buf_len = 0;			// длина запроса
